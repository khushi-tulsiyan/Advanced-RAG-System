    ...
    def _merge_with_overlap(self, pieces: Iterable[str]) -> list[str]:
        ...
        for piece in pieces:
            ...
            if current:
                ...
                tail = _overlap_tail(current, self.chunk_overlap)
...
def _overlap_tail(text: str, overlap: int) -> str:
    ...
    Slicing blindly starts the next chunk mid-word ("...ong at exact term"),
    which both reads badly and corrupts the BM25 token at the seam.
    """
